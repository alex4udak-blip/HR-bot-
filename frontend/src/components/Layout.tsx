...
export default function Layout() {
  ...
  useEffect(() => {
    ...
    } else if (['/all-candidates', '/my-funnels', '/form-builder', '/practice-list', '/document-templates', '/employees', '/my-profile', '/vacancies', '/candidates', '/interns', '/analytics', '/pen', '/calls', '/extension', '/exports', '/import'].some(p => path.startsWith(p))) {
      setActiveBlock('hr');
