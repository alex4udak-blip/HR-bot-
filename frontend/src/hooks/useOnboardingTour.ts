...
export const DEFAULT_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'AI-анализ',
    content: 'AI-ассистент поможет оценить кандидата, сравнить с требованиями вакансии и составить персонализированные вопросы для интервью.',
    placement: 'left',
    spotlightPadding: 8,
  },
  {
  ...
  },
  {
    ...
    title: 'Kanban доска',
    content: 'Переключитесь на Kanban-доску для визуального управления воронкой найма. Перетаскивайте карточки между этапами.',
    placement: 'bottom',
    spotlightPadding: 8,
  },
];
